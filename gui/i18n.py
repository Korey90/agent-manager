...
_STRINGS: dict[str, dict[str, str]] = {
    "pl": {
        ...
        "run.output_lbl":  "Rozmowa:",
        "run.output_ph":   "Tutaj pojawi się odpowiedź agenta…",
        "run.new_conv":    "🗑 Nowa rozmowa",
        "run.turn_you":    "👤 Ty",
        "run.turn_agent":  "🤖 Agent",
        "run.tool_call":   "⚙ Wywołanie skilla",
        "run.no_response": "(brak odpowiedzi)",
        "run.sessions_lbl": "Sesje",
        "run.session_del":  "🗑 Usuń sesję",
        "run.tts_tooltip":  "Auto-czytaj odpowiedzi agenta (TTS)",
        # Export panel
    ...
    "en": {
        ...
        "run.output_lbl":  "Conversation:",
        "run.output_ph":   "The agent's response will appear here…",
        "run.new_conv":    "🗑 New conversation",
        "run.turn_you":    "👤 You",
        "run.turn_agent":  "🤖 Agent",
        "run.tool_call":   "⚙ Skill call",
        "run.no_response": "(no response)",
        "run.sessions_lbl": "Sessions",
        "run.session_del":  "🗑 Delete session",
        "run.tts_tooltip":  "Auto-read agent responses (TTS)",
        # Export panel
        "export.agent_lbl":   "Agent:",
        "export.fmt_lbl":     "Format:",
